...
public class BlockFinder {
  ...
  public static Vec3i getDepthPoint(final Vec3i sourcePos, final Vec3i sensorPos, double alpha) {
    ...
    Vec3i midpoint = new BlockPos(midX, midY, midZ);
    ...
    return new Vec3i(midpoint.getX(), newY, midpoint.getZ());
  }

  // Returns all block positions along the line from source to dest (inclusive) using Bresenham's 3D
  // algorithm.
  public static List<Vec3i> listBlocks(Vec3i source, Vec3i dest) {
