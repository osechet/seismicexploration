...
public class DeploySensorsPage extends Page {
    ...
    protected DeploySensorsPage(final WorkerOrderScreen screen, final int left, final int top, final int initialX,
        ...
        startZField = new EditBox(screen.getFont(), left + 10 + 60 + 5, top + 5 + 20 + 5, 60, 20, Component.literal("start"));
        startZField.setValue(Integer.toString(initialZ));
        countField = new EditBox(screen.getFont(), left + 10, top + 5 + 20 + 5 + 20 + 5, 60, 20, Component.literal("end"));
        countField.setValue("50");
        gapField = new EditBox(screen.getFont(), left + 10, top + 5 + 20 + 5 + 20 + 5 + 20 + 5, 60, 20, Component.literal("end"));
        gapField.setValue("3");
    }
