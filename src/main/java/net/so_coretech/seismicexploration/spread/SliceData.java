...
public class SliceData {
  ...
  public SliceData(final int centerX, final int centerZ, final int axis, final ByteBuffer colors) {
    this(
        centerX,
        centerZ,
        axis,
        colors.array().length == SLICE_SIZE ? colors.array() : new byte[SLICE_SIZE]);
  }

  public SliceData(final int centerX, final int centerZ, final int axis, final byte[] colors) {
  ...
  public static SliceData fromBlocks(
      final int centerX, final int centerZ, final int axis, final Map<BlockPos, Byte> blocks) {
