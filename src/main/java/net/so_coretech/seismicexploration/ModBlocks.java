...
public class ModBlocks {
    ...
    private static final DeferredRegister.Blocks BLOCKS = DeferredRegister.createBlocks(SeismicExploration.MODID);

    //
    // Register blocks
    //

    public static final DeferredBlock<Block> BOOM_BOX = BLOCKS.registerBlock("boom_box",
    ...
    public static final DeferredBlock<Block> DFU = BLOCKS.registerBlock("dfu", SensorBlock::new,
    ...
    public static final DeferredBlock<Block> RECORDER = BLOCKS.registerBlock("recorder",
