...
public class BoomBoxBlockEntity extends BlockEntity implements TickableBlockEntity {
  ...
  public static final int cyclesCount = 5;
  ...
  public void switchPower() {
    if (level != null) {
      ...
      lvl.setBlock(
          worldPosition,
          getBlockState().setValue(BoomBoxBlock.POWERED, powered),
          Block.UPDATE_CLIENTS);
      lvl.setBlock(
          worldPosition,
          getBlockState().setValue(BoomBoxBlock.WORKING, false),
          Block.UPDATE_CLIENTS);
  ...
  public void poweroff() {
    if (level != null) {
      ...
      lvl.setBlock(
          worldPosition,
          getBlockState().setValue(BoomBoxBlock.POWERED, false),
          Block.UPDATE_CLIENTS);
      lvl.setBlock(
          worldPosition,
          getBlockState().setValue(BoomBoxBlock.WORKING, false),
  ...
  private void switchWorking() {
    if (level != null) {
      ...
      level.setBlock(
          worldPosition,
          getBlockState().setValue(BoomBoxBlock.WORKING, !working),
          Block.UPDATE_CLIENTS);
    }
  }
