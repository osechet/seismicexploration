...
public class WorkerRenderer
    extends HumanoidMobRenderer<WorkerEntity, PlayerRenderState, PlayerModel> {

  private static final ResourceLocation TEXTURE =
      ResourceLocation.fromNamespaceAndPath(
          SeismicExploration.MODID, "textures/entity/worker2.png");

  public WorkerRenderer(final EntityRendererProvider.Context context) {
    super(
        context,
        new PlayerModel(
            context.bakeLayer(net.minecraft.client.model.geom.ModelLayers.PLAYER), false),
        0.5f);
  }
